  ...
  function sendhtml() {
    ...
    for each (detail in details) {
      ...
      for each (osdetail in detail.oslist) {
        ...
        html.push('<td>&nbsp;</td>');
        html.push('<td>');
        html.push('<a href=\'../../_list/result_locations/results_by_location?include_docs=true&startkey=["' + escape(osdetail.url) + '"]&endkey=["' + escape(osdetail.url) + ', {}"]\'>Search by Location</a>');
        html.push('</td>');
        html.push('</tr>');
        html.push('</table>');
