function(head, req) {
  ...
  provides("html", function() {
    ...
    html.push('<html>');
    html.push('  <head>');
    html.push('    <title>Crash History - Bug Hunter</title>');
    ...
    while ((row = getRow())) {
      ...
      var segmented_search = segmented_key_search('results',
                                                  listPath() + '/result_crashes/crash_type/results',
                                                  'result_crash',
                                                  {
                                                    crash        : doc.crash,
      ...
      html.push('</td>');
      html.push('<td>');
      html.push(location_id_list_to_links(doc.location_id_list));
      html.push('</td>');
      html.push('</tr>');
      html.push('');
      if (open_bugs) {
