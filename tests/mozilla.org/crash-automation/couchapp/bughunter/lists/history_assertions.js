function(head, req) {
  // !json templates.history_assertions
  ...
  provides("html", function() {
             ...
             send(template(templates.history_assertions.header, {
                           }));
             var row, key;
             while ((row = getRow())) {
               ...
               if ('location_id_list' in row.doc)
                 location_id_list_links = location_id_list_to_links(row.doc.location_id_list);
               ...
               send(template(templates.history_assertions.detail, {
                               ...
                               location_id_links : location_id_list_links
                             }));
             }
             return template(templates.history_assertions.footer, {
                           });
           });
};
