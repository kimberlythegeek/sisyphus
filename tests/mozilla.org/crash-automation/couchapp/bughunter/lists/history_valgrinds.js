function(head, req) {
  // !json templates.history_valgrinds
  ...
  provides("html", function() {
             ...
             send(template(templates.history_valgrinds.header, {
                           }));
             var row, key;
             while ((row = getRow())) {
               ...
               send(template(templates.history_valgrinds.detail, {
             ...
             return template(templates.history_valgrinds.footer, {
                           });
           });
};
