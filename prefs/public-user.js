...
user_pref("network.proxy.backup.ftp", "proxy.bughunter.mdc2.mozilla.com");
user_pref("network.proxy.backup.ftp_port", 3128);
user_pref("network.proxy.backup.socks", "proxy.bughunter.mdc2.mozilla.com");
user_pref("network.proxy.backup.socks_port", 3128);
user_pref("network.proxy.backup.ssl", "proxy.bughunter.mdc2.mozilla.com");
user_pref("network.proxy.backup.ssl_port", 3128);
user_pref("network.proxy.ftp", "proxy.bughunter.mdc2.mozilla.com");
user_pref("network.proxy.ftp_port", 3128);
user_pref("network.proxy.http", "proxy.bughunter.mdc2.mozilla.com");
user_pref("network.proxy.http_port", 3128);
user_pref("network.proxy.no_proxies_on", "localhost,127.0.0.1,localaddress,.localdomain.com, 10.0.0.0/8, *.mdc2.mozilla.com, *.mdc2.mozilla.com, 169.254.169.254");
user_pref("network.proxy.share_proxy_settings", true);
user_pref("network.proxy.socks", "proxy.bughunter.mdc2.mozilla.com");
user_pref("network.proxy.socks_port", 3128);
user_pref("network.proxy.socks_remote_dns", true);
user_pref("network.proxy.ssl", "proxy.bughunter.mdc2.mozilla.com");
